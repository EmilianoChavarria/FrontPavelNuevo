    ...
    return (
        <div className='bg-white px-4 py-6 rounded-lg'>
            <header className='flex justify-between items-center mb-2'>
                <span className='text-lg'>Prueba</span>
                <button>asd</button>
            </header>
            <div className='px-1'>
                <span className='text-sm text-gray-700'>asdasd</span>
                <div>
                    <div className='flex justify-between items center mt-3 mb-1'>
                        <span className='text-sm text-gray-700'>Progreso</span>
                        <span className='text-sm text-gray-700'>33.33%</span>
                    </div>
